...
face = noone;
interact_key		= oPlayer.bind_action;
...
choice_snd_effect	= noone//snd_moveselect;
select_snd_effect	= noone//snd_select;
...
portraitHeight	= sprite_get_height(portrait_frame) * scale;
...
pos_y			= gui_height-boxHeight-700;

name_box_x		= pos_x + (-235 * scale);
name_box_y		= pos_y - (0 * scale);
