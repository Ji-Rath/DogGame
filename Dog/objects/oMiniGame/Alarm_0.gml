...
switch(GameType)
{
    ...
    case Game.CrabWeigh:
		...
		instance_create_layer(room_width/2+200,room_height/2-100, "Instances", oAnchorPoint);
		instance_create_layer(room_width/2+100,room_height/2-100, "Instances", oHand);
