...
CreateBattleTextEvent(["A "+string(EnemyBattle.Name) + " has attacked!"], false, new TextInit(0.05, c_black, 0.5));
...
function RunBattleStage()
{
	switch(BattleStage)
	{
		case BattleSection.EnemyAttack: //Enemy turn, send enemy minigame
			...
			CreateBattleTextEvent(EnemyText, false, new TextInit(0.05, c_black, 1));
			break;
