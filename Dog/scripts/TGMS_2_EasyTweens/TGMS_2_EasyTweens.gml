var HIDE_WARNING; HIDE_WARNING = TweenEasyUseDelta + TweenEasyMove + TweenEasyScale + TweenEasyRotate + TweenEasyFade + TweenEasyBlend + TweenEasyImage + TweenEasyTurn + TweenEasyPath + TweenEasySpeed + TweenEasySpeedHV;
