...
function TGMS_Begin()
{
	...
	global.TGMS_TweenDataLabelMap[? "property"] = TWEEN.PROPERTY_DATA_RAW;
	global.TGMS_TweenDataLabelMap[? "properties"] = TWEEN.PROPERTY_DATA_RAW;
	global.TGMS_TweenDataLabelMap[? "prop"] = TWEEN.PROPERTY_DATA_RAW;
